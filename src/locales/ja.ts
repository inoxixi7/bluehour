...
export default {
  ...
  weather: {
    ...
    thunderstormHeavyHail: '激しい雹を伴う雷雨',
    unknown: '不明',
    temperature: '気温',
    windSpeed: '風速',
    recommendedEV: '推奨 EV',
  ...
  settings: {
    ...
    userPresets: {
      ...
      createNew: '新規プリセット作成',
      editPreset: 'プリセット編集',
      empty: 'まだプリセットがありません。機材を簡単に設定するために作成してください。',
      active: '使用中',
      activate: '有効化',
      deactivate: '無効化',
      presetName: 'プリセット名',
      presetNamePlaceholder: '例：風景キット',
      camera: 'カメラ',
      cameraPlaceholder: '例：Nikon Z6 II',
      lens: 'レンズ',
      lensPlaceholder: '例：24-70mm f/2.8',
      useFilm: 'フィルム使用',
      selectFilm: 'フィルム選択',
      currentPreset: '現在のプリセット',
      noActivePreset: 'プリセット未選択',
      manage: 'プリセット管理',
      
      // Stepper steps
      step1Title: '基本情報',
      step1Description: 'プリセット名、カメラ、レンズ情報を入力',
      step2Title: '対応絞り',
      step2Description: '機材が対応する絞り値を選択（複数選択可）',
      step3Title: '対応シャッター',
      step3Description: '機材が対応するシャッター速度を選択（複数選択可）',
      step4Title: '対応 ISO',
      step4Description: '機材が対応する ISO 値を選択（複数選択可）',
