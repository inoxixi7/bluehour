...
export default {
  ...
  weather: {
    ...
    violentRainShowers: 'Heftige Schauer',
    thunderstorm: 'Gewitter',
    thunderstormHail: 'Gewitter mit Hagel',
    thunderstormHeavyHail: 'Schweres Gewitter',
    unknown: 'Unbekannt',
    temperature: 'Temperatur',
    windSpeed: 'Windgeschwindigkeit',
    recommendedEV: 'Empfohlener EV',
  ...
  settings: {
    ...
    userPresets: {
      ...
      createNew: 'Neue Voreinstellung',
      editPreset: 'Voreinstellung bearbeiten',
      empty: 'Noch keine Voreinstellungen. Erstellen Sie eine, um Ihre Ausrüstung schnell zu konfigurieren.',
      active: 'Aktiv',
      activate: 'Aktivieren',
      deactivate: 'Deaktivieren',
      presetName: 'Voreinstellungsname',
      presetNamePlaceholder: 'z.B. Landschaftskit',
      camera: 'Kamera',
      cameraPlaceholder: 'z.B. Nikon Z6 II',
      lens: 'Objektiv',
      lensPlaceholder: 'z.B. 24-70mm f/2.8',
      useFilm: 'Film verwenden',
      selectFilm: 'Film auswählen',
      currentPreset: 'Aktive Voreinstellung',
      noActivePreset: 'Keine aktive Voreinstellung',
      manage: 'Verwalten',
      
      // Stepper steps
      step1Title: 'Grundinformationen',
      step1Description: 'Geben Sie Voreinstellungsname, Kamera und Objektiv ein',
      step2Title: 'Unterstützte Blenden',
      step2Description: 'Wählen Sie die Blendenwerte Ihrer Ausrüstung (Mehrfachauswahl)',
      step3Title: 'Unterstützte Verschlusszeiten',
      step3Description: 'Wählen Sie die Verschlusszeiten Ihrer Ausrüstung (Mehrfachauswahl)',
      step4Title: 'Unterstützte ISO',
      step4Description: 'Wählen Sie die ISO-Werte Ihrer Ausrüstung (Mehrfachauswahl)',
      ...
      // Validation messages
      nameRequired: 'Bitte geben Sie einen Voreinstellungsnamen ein',
      saveFailed: 'Voreinstellung konnte nicht gespeichert werden',
      deleteConfirm: 'Möchten Sie die Voreinstellung "{{name}}" wirklich löschen?',
    },
  },
  reciprocityHelp: {
